...
- `M5 Push Remoto (🔴 BLOQUEIO ABSOLUTO)`: sincronizar 25 commits locais da branch `main` com GitHub origin/main — proibido qualquer `git push` remoto até autorização explícita formal + método definido (PAT SSO, SSH deploy key ou Render GitHub App) + sign-off M5-removal completo 6 pessoas + Procedimento 14 passos executados (arquivo docs/governance-sign-offs/M5-removal-2026-08-10-HEAD-24-COMMITS.md preenchido)
