...
6.  `g6 typecheck`               → mypy **STRICT 10 MÓDULOS (Shared + QA + Agents + auth_service + compliance_api + case_management + investigation_api + monitoring_api + public_api + report_api)** S31/S32/S33/S37/S38/S39/S40/S41/S42/S43 P3: 3 shared + 7 apps = disallow_untyped_defs=true; 2 apps restantes = baseline. 4 camadas fallback (mypy/PYmod/hatch/hatch PYmod)
