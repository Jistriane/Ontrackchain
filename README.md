...
- release atual: `v5.4.0 Sprint 20 RIPD Compliance Fechado` (compliance-api T2-04 structural screens Due Diligence/SoF/ScreeningOnboarding 4 work items obrigatórios RIPD Art.15, qa-gateway scan-rbac strict warnings→errors 0 warnings default, Hypothesis fuzzing Q3-02 1050 combinações property-based)
...
- `M5 Push Remoto (🔴 BLOQUEIO ABSOLUTO)`: sincronizar 16 commits locais da branch `main` com GitHub origin/main — proibido qualquer `git push` remoto até autorização explícita formal + método definido (PAT SSO, SSH deploy key ou Render GitHub App)
