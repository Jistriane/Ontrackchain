...
- release atual: `v5.5.0 Sprint 21 Graph Intelligence 4.0 + Governança Arquitetura 22 ADRs` (Graph Intelligence Cytoscape.js 6 layouts, 9 categorias nó, 4 paineis informativos; 4 ADRs novos=18→22; Baseline Executiva Readiness atualizada v1.0→v1.1 com materialidade S19-S21)
...
- `M5 Push Remoto (🔴 BLOQUEIO ABSOLUTO)`: sincronizar 17 commits locais da branch `main` com GitHub origin/main — proibido qualquer `git push` remoto até autorização explícita formal + método definido (PAT SSO, SSH deploy key ou Render GitHub App)
