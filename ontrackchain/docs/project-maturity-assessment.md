...
- [`docs/regulatory-readiness.md`](regulatory-readiness.md)
- [`docs/compliance-and-security-controls.md`](compliance-and-security-controls.md)
- [`docs/validation-and-audit.md`](validation-and-audit.md)
- [`docs/ci-cd-and-release.md`](ci-cd-and-release.md)
- [`docs/pre-production-checklist.md`](pre-production-checklist.md)
- [`docs/project-release-gates.md`](project-release-gates.md)
- [`docs/project-priority-board.md`](project-priority-board.md)
- [`docs/project-execution-plan-to-90.md`](project-execution-plan-to-90.md)
- [`docs/rbac-and-permissions.md`](rbac-and-permissions.md)
- [`docs/adrs/ADR-006-identidade-federada-e-users-locais.md`](adrs/ADR-006-identidade-federada-e-users-locais.md)
- [`docs/adrs/ADR-007-validacao-por-modo-de-autenticacao.md`](adrs/ADR-007-validacao-por-modo-de-autenticacao.md)
- [`apps/auth-service/src/auth_service/main.py`](../apps/auth-service/src/auth_service/main.py)
- [`apps/investigation-api/src/investigation_api/main.py`](../apps/investigation-api/src/investigation_api/main.py)
- [`apps/investigation-api/src/investigation_api/worker.py`](../apps/investigation-api/src/investigation_api/worker.py)
- [`apps/compliance-api/src/compliance_api/main.py`](../apps/compliance-api/src/compliance_api/main.py)
- [`apps/compliance-api/src/compliance_api/risk_provider.py`](../apps/compliance-api/src/compliance_api/risk_provider.py)
