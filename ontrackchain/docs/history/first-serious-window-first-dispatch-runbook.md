...
> Documento de apoio historico. Para execucao viva e canonica da janela seria integrada, use [Pacote Final de Execucao da Janela Seria Integrada](../governance-weekly/guides/SERIOUS_WINDOW_FINAL_EXECUTION_PACKET.md). Para artefatos executivos da tentativa corrente, use o ciclo ativo em `../governance-weekly/cycles/`.
