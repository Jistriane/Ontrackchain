...
- regulatórios: `audit`, `ros-coaf`, `evidence`, `reports`
...
- precedencia de contexto regulatório (`dossier_sha256` vs `file_hash_sha256`)
...
Adotar `hardening estatico` como baseline canônico para os contratos visuais sensiveis do frontend, com os seguintes pilares:
...
4. manter rastreabilidade documental explicita entre cockpit, spec canônica e contrato protegido;
5. exigir sincronizacao da documentação toda vez que um contrato visual protegido for alterado.
...
- melhora a capacidade de handoff entre implementacao, spec e documentação
...
- contextos regulatórios compartilhados possuem precedencia e semantica documentadas
