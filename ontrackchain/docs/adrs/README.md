...
- [ADR-016 — Observabilidade Distribuída via OpenTelemetry OTLP v1.0.0 (Tracing + Métricas + Logs LGPD/BACEN)](./ADR-016-observabilidade-opentelemetry-otlp-v1-tracing-metricas-logs-lgpd-bacen.md)
- [ADR-016-LEGADO — Estrategia de Vault e Secrets para Producao (mantido como referência; nova observabilidade absorveu secrets em 6.1 Segurança)](./ADR-016-estrategia-de-vault-e-secrets-para-producao.md)
