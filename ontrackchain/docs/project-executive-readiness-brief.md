...
- `P2-05` entrou em trilho real de enforcement fino: `REVIEWER` e `BILLING_ADMIN` ja operam em superficies concretas, incluindo `manual-package`, `ROS/COAF`, `billing/balance` e `billing/reconciliation`
