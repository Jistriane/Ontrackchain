...
- atualizar pacote de governanca local em comando unico:
  - `make refresh-staging-war-room-governance-local WINDOW_ID=stg-2026-07-06-a`
  - dashboard executivo: `docs/governance-weekly/stg-2026-07-06-a-governance-dashboard.md`
  - checklist de desbloqueio: `docs/governance-weekly/stg-2026-07-06-a-unblock-checklist.md`
  - resumo executivo curto: `docs/governance-weekly/stg-2026-07-06-a-governance-dashboard.md`
- atualizar plano automatico por dominio:
  - `make render-staging-war-room-action-plan WINDOW_ID=stg-2026-07-06-a`
  - referencia: `docs/governance-weekly/stg-2026-07-06-a-war-room-action-plan.md`
