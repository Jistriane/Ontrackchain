...
- janela datada ativa: `stg-2026-07-13-a`
- modo atual: `dress_rehearsal_controlado`
- decisao corrente: `pending_no_go`
- camada executiva esperada apos payload consolidado: `sign-off` versionado + `go/no-go decision packet`
...
- [Tracking ao Vivo da Trilha Federada](./2026-07-13-federated-directory-live-tracking.md)
- [War Room da Trilha Federada](./2026-07-13-federated-directory-war-room.md)
