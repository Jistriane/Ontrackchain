# Guias Permanentes da Governanca Semanal

## Objetivo

Concentrar guias operacionais permanentes da governanca semanal que nao pertencem a um ciclo especifico, nao sao templates e nao sao artefatos gerados.
...
- `P0-04_REGULATORY_BUNDLE_EXECUTION_GUIDE.md` detalha apenas a trilha especializada do bundle regulatorio oficial
