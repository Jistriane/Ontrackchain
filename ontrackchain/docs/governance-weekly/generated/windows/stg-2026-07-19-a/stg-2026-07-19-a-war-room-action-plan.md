# Plano de Acao do War Room - stg-2026-07-19-a

- gerado em: `2026-07-19T01:08:24.292270+00:00`
- checks_dir: `artifacts/staging/checks`
- fonte placeholders: `artifacts/staging/checks/placeholders-stg-2026-07-19-a.json`
- fonte handoff: `artifacts/staging/checks/handoff-stg-2026-07-19-a.json`
...
- rerodar `python scripts/prepare_staging_window.py --window-id stg-2026-07-19-a --mode baseline --private-env-file .env.staging.private --validate --preflight`
- se verde, executar `python scripts/run_staging_window.py --window-id stg-2026-07-19-a --private-env-file .env.staging.private`
