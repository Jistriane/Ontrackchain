# Staging Window Status Snapshot - stg-2026-07-20-a

## Resumo

- window_id: `stg-2026-07-20-a`
...
- arquivo fonte: `artifacts/staging/checks/stg-2026-07-20-a-status-snapshot.json`

## Steps

| Step | Status | Exit Code | Generated At |
| --- | --- | --- | --- |
| prepare_staging_window | `failed` | `1` | `2026-07-20T19:02:37.567118+00:00` |
| run_staging_window | `failed` | `1` | `2026-07-20T19:02:37.869745+00:00` |
...
- artifact: `Mandatory artifact missing: Release dossier (stg-2026-07-20-a-dossier.json)`
