...
3. Executar os comandos sugeridos por trilha e anexar evidências em `artifacts/staging/checks` e `artifacts/staging/dossiers`.
...
- placeholders:
- contexto regulatório: escopo atual `none` com `P0-04=unknown`
...
- placeholders pendentes: `0`
- handoff pendente: `0`
- se o escopo regulatório for parcial, nao marcar `P0-04` como fechado
- so considerar promocao oficial de `P0-04` quando `P0-02` e `P0-03` convergirem na mesma trilha revisável
