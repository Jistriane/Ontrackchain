# Arquivo Historico da governança
...
Esta pasta preserva historico frio consolidado da governanca. Ela existe para consulta e rastreabilidade, nao para orientar operação corrente.

Quando houver conflito, use esta precedencia:

1. `../../README.md` e os documentos canonicamente indexados nele
2. `../cycles/` para evidência datada ainda navegavel por semana ou janela
...
- nao use esta pasta como fonte primaria para operação atual, baseline executiva ou contrato canônico
