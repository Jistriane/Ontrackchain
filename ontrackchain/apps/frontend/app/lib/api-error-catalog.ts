...
const API_ERROR_MESSAGE_KEYS: Partial<Record<string, MessageKey>> = {
  ...
  preventive_block_read_role_required: "apiErrors.preventiveBlockReadRoleRequired",
  ...
  report_read_role_required: "apiErrors.reportReadRoleRequired",
  ...
  manual_package_read_role_required: "apiErrors.manualPackageReadRoleRequired" as MessageKey,
  manual_package_admin_role_required: "apiErrors.manualPackageAdminRoleRequired" as MessageKey,
  manual_package_signoff_role_required: "apiErrors.manualPackageSignoffRoleRequired" as MessageKey,
