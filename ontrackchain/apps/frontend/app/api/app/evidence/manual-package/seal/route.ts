...
import { getStandaloneShowcaseManualPackageSealByDigest } from "../../../../../lib/standalone-showcase";
...
export async function GET(request: Request) {
  if (isFrontendStandaloneShowcaseMode()) {
    ...
    const seal = getStandaloneShowcaseManualPackageSealByDigest(packageSha256, policyVersion);
    if (!seal) {
