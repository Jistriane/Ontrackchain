...
export async function GET(request: Request, context: { params: Promise<{ counterpartyId: string }> }) {
  ...
  const res = await fetch(`${baseUrl}/api/v1/compliance/counterparties/${counterpartyId}/history${query}`, {
    method: "GET",
    headers: {
