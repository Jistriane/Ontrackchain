...
async def healthz_liveness_probe():
    ...
    body = {
        ...
        "service_id": f"ontrackchain/report-api",
    }
    return Response(
        status_code=200,
...
fastapi_info{service="report-api",version="3.1.0-m5"} 1.0
# HELP http_requests_total Total HTTP requests (fallback inline).
# TYPE http_requests_total counter
http_requests_total{service="report-api",endpoint="/healthz",method="GET",status_code="200"} 0
# HELP up Liveness probe (1 = UP).
# TYPE up gauge
up{service="report-api"} 1.0
"""
